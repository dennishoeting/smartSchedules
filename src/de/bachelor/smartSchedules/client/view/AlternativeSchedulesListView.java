 ...
 * @author Dennis
 */
public class AlternativeSchedulesListView extends Window {
	/**
	 ...
	 * Konstruktor
	 */
	public AlternativeSchedulesListView() {
		/*
		 * Initialisierung
		 */
...
//		this.draw();
	...
	public class AlternativesListGrid extends ListGrid {
		...
		private AlternativesListGrid(int width, int height) {
			...
			creator.setWidth(180);
			final ListGridField creationDuration = new ListGridField("creationDuration", "Dur.");
			creationDuration.setWidth(70);
			final ListGridField evaluation = new ListGridField("evaluation", "Eval.");
			evaluation.setWidth(70);
			final ListGridField isMarked = new ListGridField("isMarked", "&nbsp;");
			isMarked.setType(ListGridFieldType.BOOLEAN);
			isMarked.setWidth(20);
			
			this.setFields(creationDate, creator, creationDuration, evaluation, isMarked);
		}
	}
}
