 ...
 */
package main.java.com.bradrydzewski.gwtgantt.model;
...
public class Task implements Serializable {
	private static final long serialVersionUID = 6601071106867355541L;
    ...
    private String style = STYLE_GREEN;
    ...
    public void setStart(Date start) {
        this.start = start;
//        System.err.println("Task:startTime for "+this.UID+"="+start);
    }
	...
	public void setSelected(boolean selected) {
		...
		this.style = ((selected)?(GanttManager.getSelectedTaskColor()):GanttManager.getNormalTaskColor());
	}
	...
	public void setFinished(boolean isFinished) {
		...
		this.style = ((isFinished)?(GanttManager.getFinishedTaskColor()):GanttManager.getNormalTaskColor());
	}
	...
	public void setLate(boolean isLate) {
		this.isLate = isLate;
		this.style = ((isLate)?(GanttManager.getLateTaskColor()):GanttManager.getNormalTaskColor());
	}
