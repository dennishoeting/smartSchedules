...
public class GanttChartPresenterHourImpl<T> extends GanttChartPresenter<T> {
    ...
    protected void renderBackground() {
        ...
        for(int i=0;i<diff;i++) {
            ...
            for(int h=0;h<4;h++) {
            	width = UNIT_WIDTH * 6 - 2;
                Rectangle bottomTimescaleBounds = new Rectangle(left, 0, width, 25);
                // TODO ROFFEL!
                String bottomTimescaleString = ((h<2)?((h==0)?"12pm-6am":"6am-12am"):((h==2)?"12am-6pm":"6pm-12pm"));
