...
import main.java.com.bradrydzewski.gwtgantt.model.ZoomLevel;
import main.java.com.bradrydzewski.gwtgantt.resources.GanttResources;
...
public class GanttChart<T> extends ResizeComposite implements HasScrollHandlers, TaskDisplay<T> {
    ...
    private TaskDisplayPresenter<T> hourPresenter = GWT.create(GanttChartPresenterHourImpl.class);
    private TaskDisplayPresenter<T> minutePresenter = GWT.create(GanttChartPresenterMinuteImpl.class);
    private TaskDisplayPresenter<T> secondPresenter = GWT.create(GanttChartPresenterSecondImpl.class);
...
//        presenter.fireEvent(event);
	...
	public void setZoomLevel(ZoomLevel zoom) {
		...
		case Hour: this.presenter = hourPresenter; break;
		case Minute: this.presenter = minutePresenter; break;
		case Second: this.presenter = secondPresenter; break;
		}
	...
	public ZoomLevel getZoomLevel() {
		...
		} else if(presenter instanceof GanttChartPresenterHourImpl) {
			return ZoomLevel.Hour;
		} else if(presenter instanceof GanttChartPresenterMinuteImpl) {
			return ZoomLevel.Minute;
		} else if(presenter instanceof GanttChartPresenterSecondImpl) {
			return ZoomLevel.Second;
	...
	public boolean zoomIn() {
		...
		case Day: newZoom = ZoomLevel.Hour; break;
		case Hour: newZoom = ZoomLevel.Minute; break;
		case Minute: newZoom = ZoomLevel.Second; break;
		case Second: break;
	...
	public boolean zoomOut() {
		...
		case Hour: newZoom = ZoomLevel.Day; break;
		case Minute: newZoom = ZoomLevel.Hour; break;
		case Second: newZoom = ZoomLevel.Minute; break;
		}
