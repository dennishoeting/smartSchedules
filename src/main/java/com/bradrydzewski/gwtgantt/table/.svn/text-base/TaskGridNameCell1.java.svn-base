 ...
 */
public abstract class TaskGridNameCell1 extends AbstractEditableCell<TaskGridNameCell1.TaskGridNameCellDetails, TaskGridNameCell1.ViewData> {

    public class TaskGridNameCellDetails {
        private String name;
        ...
        static class ViewData {
                ...
                private TaskGridNameCellDetails task;
                 ...
                 *            the text to edit
                 */
                public ViewData(TaskGridNameCellDetails task) {
                        this.task = task;
                ...
                public TaskGridNameCellDetails getTask() {
                        return task;
                }
         ...
         */
        public TaskGridNameCell1(SafeHtmlRenderer<String> renderer) {
        ...
        @Override
        public boolean isEditing(Element element, TaskGridNameCellDetails value, Object key) {
                ViewData viewData = getViewData(key);
                return viewData == null ? false : viewData.isEditing();
        }

        @Override
        public void onBrowserEvent(Element parent, TaskGridNameCellDetails value, Object key,
...
//                              }
        ...
        public abstract void onExpandCollapse(TaskGridNameCellDetails task);

        @Override
        public void render(TaskGridNameCellDetails value, Object key, SafeHtmlBuilder sb) {
                // Get the view data.
                ViewData viewData = getViewData(key);
        ...
        @Override
        public boolean resetFocus(Element parent, TaskGridNameCellDetails value, Object key) {
         ...
         */
        protected void edit(Element parent, TaskGridNameCellDetails value, Object key) {
         ...
         *            the current value
         */
        private void cancel(Element parent, TaskGridNameCellDetails value) {
        ...
        private void commit(Element parent, ViewData viewData,
                        ValueUpdater<TaskGridNameCellDetails> valueUpdater) {
                TaskGridNameCellDetails value = updateViewData(parent, viewData, false);
